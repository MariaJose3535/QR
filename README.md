...
## 📖 Descripción general
este programa solo nos muestra un codigo QR
...
### 💡 Lo que aprendí
En esta sección describe brevemente **qué aprendiste o reforzaste** Aprendí a crear componentes reutilizables utilizando Astro y a aplicar estilos con Tailwind CSS. 
También reforcé el uso de HTML semántico y la creación de diseños responsivos que se adaptan 
...
- **Nombre completo:** MARIA JOSE GUERRERO RIOS  
- **Carrera:** TIC´S
- **Grupo:** TC1
- **Correo institucional:**  23151341@aguascalientes.tecnm.mx
...
- ¿Qué fue lo más fácil o lo más difícil de realizar?  la mas dificil fue el utilizar el astro ta que todavia no entiendo muy bien como funciona 
- ¿Qué parte disfrutaste más del desarrollo?  lo que mas disfrute fue el replicar la imagen ya que es donde me puse a pensar cuanto poner 
- ¿Qué conceptos nuevos aprendiste?  pues aprendi mas de astro de como se utiliza y de crear
- ¿Cómo aplicarías lo aprendido en proyectos futuros? pues utilizando astro en paginas que me pidan 
